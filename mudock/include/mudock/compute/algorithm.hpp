...
namespace mudock {
  ...
  enum class search_algorithm : int { NONE = 0, GENETIC, LGA };
  ...
  inline constexpr std::array<search_algorithm_description, 3> SEARCH_ALGORITHM_DICT = {
      {{search_algorithm::NONE, "none"}, {search_algorithm::GENETIC, "genetic"}, {search_algorithm::LGA, "lga"}}};
