...
command_line_arguments parse_command_line_arguments(const int argc, char* argv[]) {
  ...
  arguments_description.add_options()("score",
                                      ...
                                      "Scoring function to apply: adt|vinardo");
  ...
  if (vm.count("help") > 0) {
    ...
    std::cout << "USAGE: " << argv[0] << " --protein|-p " << args.protein_path << " --ligand|-l "
              ...
              << " [--search none|genetic] [--score adt|vinardo] [MORE_CONFIGS...] [KNOBS] " << std::endl;
    std::cout << std::endl;
    ...
    std::cout << "Pipeline selection:" << std::endl
              ...
              << "  --search none --score vinardo  vinardo scoring only" << std::endl
              << "  --search genetic --score vinardo genetic + vinardo" << std::endl;
    std::cout << std::endl;
