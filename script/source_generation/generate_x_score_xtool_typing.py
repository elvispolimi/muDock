...
json_filepath = script_dirpath.parent.parent / "chem" / "x_score_xtool_types.json"
...
header_source_filepath = (
    ...
    / "mudock"
    / "chem"
    / "x_score_xtool_types.hpp"
)
source_source_filepath = (
    script_dirpath.parent.parent / "mudock" / "src" / "chem" / "x_score_xtool_types.cpp"
)
...
template = env.get_template("x_score_xtool_types.template.hpp")
with open(header_source_filepath, "w") as outfile:
    outfile.write(template.render(context))
template = env.get_template("x_score_xtool_types.template.cpp")
