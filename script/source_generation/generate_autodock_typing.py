...
json_filepath = script_dirpath.parent.parent / "chem" / "autodock_babel_types.json"
...
header_source_filepath = (
    ...
    / "mudock"
    / "chem"
    / "autodock_babel_types.hpp"
)
source_source_filepath = (
    script_dirpath.parent.parent / "mudock" / "src" / "chem" / "autodock_babel_types.cpp"
)
...
template = env.get_template("autodock_babel_types.template.hpp")
with open(header_source_filepath, "w") as outfile:
    outfile.write(template.render(context))
template = env.get_template("autodock_babel_types.template.cpp")
